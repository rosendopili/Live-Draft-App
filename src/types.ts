...
export interface DraftPick {
  ...
  raw_text: string;
  confidence: number;
  status?: 'confirmed' | 'needs_review' | 'edited';
  notes?: string;
}
...
export interface DraftSettings {
  ...
  scoring_format: 'PPR' | 'Half-PPR' | 'Standard' | 'TE Premium' | '2QB / Superflex';
  my_team_column: number;
...
export interface OCRResult {
  ...
  summary?: {
    ...
    positions_breakdown: Record<Position, number>;
  };
